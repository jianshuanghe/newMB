<template>
	<view class="find-Purchase">
		<view v-for="(item,index) in arr" :key="index">
			<view class="find-Purchase-head" v-if="item.userAuth==1" @tap="gotocomp()">
			...
			<view class="find-Purchase-con">
				<view class="find-Purchase-con-one">
					...
					<view class="find-Purchase-conE">{{item.moneyStr}}</view>
				...
				<view class="find-Purchase-con-two" v-if="item.instStyleType==1||item.instStyleType==3">
					...
					<view v-if="item.instStyleType==3">立即联系</view>
				</view>
			</view>
