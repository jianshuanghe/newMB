<!-- 实例
 <changeImgTips
 	...
 	@delete-Image="deleteImage(index)" // 删除
 	@change-Image="changeImage" // 替换
 	@add-Image="addImage" // 增加
		...
		<div class="prover-cont">
			<div class="popover_content" v-if="tipsType === '1'" style="width: 13.333vw">
				<div class="popover_btns">
					<a style="width: 100%"><label @tap="addImage">添加</label></a>
				</div>
			</div>
			<div class="popover_content" v-if="tipsType === '2'" :style="{width: '26.666vw', margin: tipsLeft}">
				<div class="popover_btns">
					<a><label @click="changeImage">替换</label></a>
					<a @click="deleteImage">移除</a>
				</div>
			</div>
			<div class="popover_content" v-if="tipsType === '2.1'" :style="{width: '26.666vw', margin: tipsLeft}">
				<div class="popover_btns">
					<a><label @click="changeImage">替换</label></a>
					<a @click="addImage">添加</a>
				</div>
			</div>
			<div class="popover_content" v-if="tipsType === '3'" style="width: 39.999vw">
				<div class="popover_btns">
					<a style="width: 33.33%"><label @click="changeImage">替换</label></a>
					<a style="width: 33.33%"><label @click="deleteImage">移除</label></a>
					<a style="width: 33.33%" @tap="addImage">添加</a>
				</div>
			</div>
