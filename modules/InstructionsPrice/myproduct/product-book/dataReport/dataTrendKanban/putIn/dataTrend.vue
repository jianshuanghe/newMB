			...
			if (uni.getStorageSync('landRegist')) {
				...
				uni.request({
					...
					success: response => {
						...
						this.i18n.itemList2[2].code = this.timess.userCost;
						this.i18n.itemList2[3].code = this.timess.countInfo;
						this.i18n.itemList2[4].code = this.timess.clikeCount;
						this.i18n.itemList2[5].code = this.timess.clikeCountRate;
						this.i18n.itemList2[6].code = this.timess.converCount;
						this.i18n.itemList2[7].code = this.timess.converCountRate;
						this.i18n.itemList2[8].code = this.timess.submitCount;
						this.i18n.itemList2[9].code = this.timess.telCount;
						this.i18n.itemList2[10].code = this.timess.followCount;
						this.i18n.itemList2[11].code = this.timess.chatCount;
						this.i18n.itemList2[12].code = this.timess.inquCount;
						this.i18n.itemList2[13].code = this.timess.orderCount;
					},
					fail: error => {
