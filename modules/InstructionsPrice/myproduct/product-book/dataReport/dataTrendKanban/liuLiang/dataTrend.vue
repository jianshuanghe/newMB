				...
				<view class="tongji-box">
					<view class="item-tj">
						<scroll-view class="scroll-view_H" scroll-x="true">
							<view class="tongji-item left" v-for="(item, index) in i18n.flowList2" :key="index">
								<view class="items-YY">
...
export default {
	...
	methods: {
		...
		stomTime: function(stomTime) {
			...
			this.dataTrendKanban.starTime=stomTime[0];
			this.dataTrendKanban.endTime=stomTime[1];
			...
			if (uni.getStorageSync('landRegist')) {
				...
				uni.request({
					...
					success: response => {
						...
						this.i18n.flowList2[0].code = this.timess.infoCount;
						this.i18n.flowList2[1].code = this.timess.likeCount;
						this.i18n.flowList2[2].code = this.timess.followCount;
						this.i18n.flowList2[3].code = this.timess.shareCount;
						this.i18n.flowList2[4].code = this.timess.msgCount;
						this.i18n.flowList2[5].code = this.timess.telCount;
						this.i18n.flowList2[6].code = this.timess.inquCount;
						this.i18n.flowList2[7].code = this.timess.chatCount;
						this.i18n.flowList2[8].code = this.timess.orderCount;
					},
					fail: error => {
						uni.hideLoading(); // 隐藏 loading
						uni.showToast({
