	...
	<div class="template-Items">
		<div class="mode-list" :id='dataLists.id'>
			...
			<div class="mode-items" >
				...
				<!-- 组件 产品细节 -->
				<IMGCONTENTC
				v-if="dataLists.type === 'IMG_CONTENT_C'"
				:basicData='basicDatas'
				:scrollTop='scrollTops'
				:disabled='disableds'
				:dataList='dataLists'
