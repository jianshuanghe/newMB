	...
	<div class="preview-box">
		...
		<div class="preview-content">
				...
				<div class="reportFrom-box">
					<div class="reportFrom">
						<div class="RF-cont borderRight borderLeft" >
							...
							<!-- 报价含税 -->
							<div class="RF-lists" v-if='caiGouList.purcInvo'>
								<div class="RF-item width1 left">
							...
							<!-- 报价含运费 -->
							<div class="RF-lists"  v-if='caiGouList.purcFrei'>
								<div class="RF-item width1 left">
			...
			<div class="caiGou-img">
				<div class="imgList-items" v-for="(items, index) in listData.imageData" :key="index">
...
<script>
	...
	import store from '@/static/mbcImg/publish/purchase/store.png';
		...
		methods: {
			...
			caiGouSavePublish (e) {
				...
				if (!uni.getStorageSync('landRegist')) {
					...
					uni.request({
						url: this.api2 + '/rest-rp/purc/add', //接口地址。
						data: params,
						method: 'POST',
						header: {
						...
						success: response => {
							if (response.data.ret === '200') {
								...
								if (e === '0') { // 保存
									...
									uni.navigateTo({
										url: '/modules/publishPurchase/publishPurchaseFinish/publishPurchaseFinishShare?urlParams=' + this.urlCrypto(response.data.content, 0)
									});
								} else if (e === '1') { // 发布
									uni.showToast({
										title: '发布成功！',
			...
			tapCollectPreview() {
				console.log(this.businessTemList.content, '收藏');
				let parmas = {
					userId: this.routeParam.lookUserId,
