						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								...
								<div class="img-MIDW left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcUnit" placeholder="单位" typeInput="1"></wInput></view>
								</div>
								<div class="clear"></div>
							</div>
						</div>
				...
				<div class="MI-box M-Bttom">
					...
					<div class="addCaiGouDetaile">
						...
						<div class="caigouDetaile" v-for="(items, index) in caiGouList.requList" :key="index">
							<!-- 采购title -->
							<div class="cGTitle left"><wInput v-model="items.paraKey" placeholder="采购要求" typeInput="2"></wInput></div>
							<!-- 采购content -->
