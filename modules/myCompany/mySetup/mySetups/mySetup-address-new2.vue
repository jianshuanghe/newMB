	...
	<view class="mySetup-address-new">
		...
		<view class="mySetup-address-new-detailed">
			...
			<view class="mySetup-address-new-name">
				...
				<!-- 名字 -->
				<view><input type="text" :placeholder="i18n.title63" placeholder-style="color: #BDBDBD" v-model="GET_MY.ress.addrName"/></view>
			...
			<view class="mySetup-address-new-name">
				...
				<!-- 手机或固定电话 -->
				<view><input type="text" :placeholder="i18n.title64" maxlength="11" placeholder-style="color: #BDBDBD" v-model="GET_MY.ress.addrPhone"/></view>
			</view>
			...
			<view class="mySetup-address-new-name">
				...
				<view>
					...
					<view class="mySetup-address-dili">
						...
						:value="GET_MY.ress.addrPcodeStr+'-'+GET_MY.ress.addrCcodeStr+'-'+GET_MY.ress.addrAcodeStr"
						></provinceCity>
					</view>
				</view>
			...
			<view class="mySetup-address-new-names">
				...
				<!-- 如街道，楼层，门牌号等信息 -->
				<view><input type="text" :placeholder="i18n.title67" placeholder-style="color: #BDBDBD" v-model="GET_MY.ress.address"/></view>
			</view>
			<view class="mySetup-address-new-mo">
				<image :src="xuanzhong" v-if="GET_MY.ress.addrState === '1'" @tap="xuan(1)"></image>
				<image :src="weixuan" v-if="GET_MY.ress.addrState === '0'" @tap="xuan(0)"></image>
				<!-- 默认发货地址 -->
