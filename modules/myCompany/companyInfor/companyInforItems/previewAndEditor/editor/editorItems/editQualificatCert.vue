				...
				<div class="MI-box M-Bttom">
					...
					<div class="MI-items">
						...
						<div class="MI-hao" @tap="screenDataPopup()">
							<div class="MII-nih" v-if="this.Effec==''&&this.list.qualTime==''">请选择</div>
							<div class="MII-nih" style="color:black;" v-if="this.Effec!=''">{{Effec}}</div>
							<div class="MII-nih" style="color:black;" v-if="this.Effec==''&&this.list.qualTime!=''&&this.times!=='NaN'">{{times|formatDate}}</div>
					...
					<div class="MI-items">
						...
						<div class="MI-hao" @tap="area()">
							<div class="MII-nih" v-if="this.placker==undefined&&this.list.regAcodeStr==''">请选择</div>
