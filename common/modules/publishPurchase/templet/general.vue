	...
	<div class="editBasicInfor-content">
		...
		<div class="editBasicInfor">
			<div class="editBasicInfor-box">
				<div class="caigou-title">采购商品</div>
				<div class="MI-box M-Bttom">
						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								<div class="img-MI EBI-img-MI left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcTitle" placeholder="请输入商品名称" :maxlength="100" typeInput="1"></wInput></view>
								</div>
							</div>
						</div>
						<div class="clear"></div>
						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								<div class="img-MINUM left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcCount" placeholder="采购数量" typeInput="1"></wInput></view>
									<div class="line-YYCG"></div>
								</div>
					...
					<div class="addCaiGouDetaile">
						...
						<div class="caigouDetaile" v-for="(items, index) in caiGouList.paraList" :key="index">
							<!-- 采购title -->
							<div class="cGTitle left"><wInput v-model="items.paraKey" placeholder="采购明细" typeInput="2"></wInput></div>
							<!-- 采购content -->
							<div class="cGCont left"><wInput v-model="items.paraValue" placeholder="请输入该采购明细的说明" ></wInput></div>
							<!-- 采购删除 -->
				...
				<div class="MI-box M-Bttom">
					...
					<div class="addCaiGouDetaile">
						...
						<div class="caigouDetaile" v-for="(items, index) in caiGouList.requList" :key="index">
							<!-- 采购title -->
							<div class="cGTitle left">
								<wInput 
								v-model="items.paraKey" 
								placeholder="采购要求" 
								placeholderStyle='color: #2E2E30'
								typeInput="2"
								></wInput>
							</div>
							<!-- 采购content -->
							<div class="cGCont left"><wInput v-model="items.paraValue" placeholder="请输入该采购要求的说明" ></wInput></div>
							<!-- 采购删除 -->
					...
					<div class="MI-items">
						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								<div class="img-MI EBI-img-MI left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcContent" placeholder="您的其他要求"></wInput></view>
								</div>
							</div>
						</div>
						<div class="clear"></div>
