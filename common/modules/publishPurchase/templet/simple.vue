				...
				<div class="MI-box M-Bttom">
						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								<div class="img-MI EBI-img-MI left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcTitle" placeholder="您的采购名称" :maxlength="100" typeInput="1"></wInput></view>
								</div>
							</div>
						</div>
						<div class="clear"></div>
					...
					<div class="MI-items">
						...
						<div class="MI-right right">
							<div class="right-Box-MI">
								<div class="img-MI EBI-img-MI left">
									<view class="BI-text-right"><wInput v-model="caiGouList.purcContent" placeholder="您的其他要求" typeInput="1"></wInput></view>
								</div>
							</div>
						</div>
						<div class="clear"></div>
