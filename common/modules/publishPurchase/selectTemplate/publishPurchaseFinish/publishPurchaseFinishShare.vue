	...
	<view class="QRcodelist-edit">
		...
		<div class="finishShare-content">
			...
			<div class="tempIntro">
				...
				<div class="introBox">商品名称 &nbsp&nbsp{{dataLists.purcTitle}}</div>
				<div class="introBox" v-if='dataLists.addrStr'>收货城市 &nbsp&nbsp{{dataLists.addrStr}}</div>
				<div class="introBox" v-if='dataLists.purcEndTime'>报价截止 &nbsp&nbsp{{dataLists.purcEndTime}}</div>
			</div>
		</div>
