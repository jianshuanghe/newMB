<template>
	<view class="find-message">
		...
		<view class="find-message-name">
			<view>姓名</view>
			<view><input v-model="name" type="text" placeholder="如何称呼您？" placeholder-style="color: #BDBDBD;"/></view>
		</view>
		<view class="find-message-name">
			<view>电话</view>    
			<view><input type="text" maxlength="11" v-model="phone" placeholder="请留下您的联系方式..." placeholder-style="color: #BDBDBD;"/></view>
		</view>
		<view class="find-message-names">
			<view>留言</view>
			<view><textarea v-model="liu" maxlength="300" placeholder="请留下您相对我们说的话..."  placeholder-style="color: #BDBDBD;"/></view>
