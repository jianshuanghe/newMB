<template>
	<div class="editor-content">
		<!-- <div class="" v-if="ADDRESSBS"> -->
			<!--地址组件-->
			<!-- <addressBs></addressBs> -->
		<!-- </div> -->
		<div class="">
			<!--基本信息编辑-->
			<!-- <div class="editor-basic" v-if="true">
				<topBox><p class="title-putIn">编辑基本信息</p></topBox>
				<editBasicInfor></editBasicInfor>
			</div> -->
			<!-- 资质认证编辑--> 
			<div class="editor-qualificatCert" v-if="true" >
				<topBox>
				  <p class="title-putIn">编辑认证信息</p>
				</topBox>
				<editQualificatCert :listid="this.listid"></editQualificatCert>
		  </div>
		</div>
...
export default {
	...
	computed: {
		...mapGetters(['PERSONCENTER', 'ADDRESSBS', 'QUICKNAVCO'])
	},
	onLoad:function(){
