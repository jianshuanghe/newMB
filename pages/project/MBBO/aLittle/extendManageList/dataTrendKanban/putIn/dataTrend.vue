			...
			if (uni.getStorageSync('landRegist')) {
				...
				uni.request({
					...
					success: response => {
						...
						this.i18n.itemList[0].code = this.timess.sumMoneyStr;
						this.i18n.itemList[1].code = this.timess.scaleMoneyStr;
						this.i18n.itemList[2].code = this.timess.userCost;
						this.i18n.itemList[3].code = this.timess.countInfo;
						this.i18n.itemList[4].code = this.timess.clikeCount;
						this.i18n.itemList[5].code = this.timess.clikeCountRate;
						this.i18n.itemList[6].code = this.timess.converCount;
						this.i18n.itemList[7].code = this.timess.converCountRate;
						this.i18n.itemList[8].code = this.timess.submitCount;
						this.i18n.itemList[9].code = this.timess.telCount;
						this.i18n.itemList[10].code = this.timess.followCount;
						this.i18n.itemList[11].code = this.timess.chatCount;
						this.i18n.itemList[12].code = this.timess.inquCount;
						this.i18n.itemList[13].code = this.timess.orderCount;
					},
					fail: error => {
